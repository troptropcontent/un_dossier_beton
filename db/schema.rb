...
ActiveRecord::Schema[7.0].define(version: 2023_10_17_162204) do
  ...
  create_table "configurations_aggregates", force: :cascade do |t|
    t.bigint "field_id", null: false
    t.bigint "field_to_aggregate_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["field_id"], name: "index_configurations_aggregates_on_field_id"
    t.index ["field_to_aggregate_id"], name: "index_configurations_aggregates_on_field_to_aggregate_id"
  end
  ...
  add_foreign_key "configurations_aggregates", "fields"
  add_foreign_key "configurations_aggregates", "fields", column: "field_to_aggregate_id"
